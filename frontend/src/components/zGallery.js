          ...
          <Grid item xs={12} className="desk1 nodrag">
            <Card>
              <CardMedia
                component="img"
                height="100%"
                image={require('../assets/370z/1.jpg')}
                alt="1"
              />
            </Card>
          </Grid>
          <Grid item xs={12} className="desk1 nodrag">
            <Card>
              <CardMedia
                component="img"
                height="100%"
                image={require('../assets/370z/2.jpg')}
                alt="2"
              />
            </Card>
          </Grid>
          <Grid item xs={4} className="desk1 nodrag">
            <Card>
              <CardMedia
                component="img"
                height="100%"
                image={require('../assets/370z/6.jpg')}
                alt="3"
              />
            </Card>  
            </Grid>
            ...
            <Card>
              <CardMedia
                component="img"
                height="100%"
                image={require('../assets/370z/5.jpg')}
                alt="8"
              />
            </Card>
          </Grid>
            ...
            <Card>
              <CardMedia
                component="img"
                height="100%"
                image={require('../assets/370z/7.jpg')}
                alt="4"
              />
            </Card>
          </Grid>
          <Grid item xs={12} className="desk1 nodrag">
            <Card>
              <CardMedia
                component="img"
                height="100%"
                image={require('../assets/370z/4.jpg')}
                alt="6"
              />
            </Card>
          </Grid>
